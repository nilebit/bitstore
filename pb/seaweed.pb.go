...
func (*Heartbeat) Descriptor() ([]byte, []int) {
	return fileDescriptor_a86d47bfa0e713a8, []int{0}
}
...
func (*HeartbeatResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a86d47bfa0e713a8, []int{1}
}
...
func (*VolumeInformationMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_a86d47bfa0e713a8, []int{2}
}
...
func init() { proto.RegisterFile("seaweed.proto", fileDescriptor_a86d47bfa0e713a8) }

var fileDescriptor_a86d47bfa0e713a8 = []byte{
...
func (c *seaweedClient) SendHeartbeat(ctx context.Context, opts ...grpc.CallOption) (Seaweed_SendHeartbeatClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Seaweed_serviceDesc.Streams[0], "/pb.Seaweed/SendHeartbeat", opts...)
	if err != nil {
		return nil, err
	}
...
func (*UnimplementedSeaweedServer) SendHeartbeat(srv Seaweed_SendHeartbeatServer) error {
